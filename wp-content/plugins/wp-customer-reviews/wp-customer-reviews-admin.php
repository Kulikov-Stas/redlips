            ...
            <h2>Customer Reviews - <?php echo $status_text; ?> Reviews</h2>
              ...
              <div class="tablenav">
                <div class="alignleft actions">
                      <select name="action">
                            <option selected="selected" value="-1">Массовые действия</option>
                            <option value="bunapprove">Отклонить</option>
                            <option value="bapprove">Утвердить</option>
                            <option value="btrash">Переместить в корзину</option>
                            <option value="bdelete">Удалить навсегда</option>
                      </select>&nbsp;
                      <input type="submit" class="button-secondary apply" name="act" value="Применить" id="doaction" />
                </div><br class="clear" />
              </div>
              ...
              <table cellspacing="0" class="widefat comments fixed">
                <thead>
                  <tr>
                    ...
                    <th style="" class="manage-column column-author" id="author" scope="col">Автор</th>
                    <th style="" class="manage-column column-comment" id="comment" scope="col">Отзыв</th>
                  </tr>
                </thead>
                ...
                <tfoot>
                  <tr>
                    ...
                    <th style="" class="manage-column column-author" scope="col">Автор</th>
                    <th style="" class="manage-column column-comment" scope="col">Отзыв</th>
                  </tr>
                </tfoot>
                      ...
                      <tr class="approved" id="review-<?php echo $rid;?>">
                        ...
                        <td class="comment column-comment">
                          ...
                          <div class="row-actions">
                            ...
                            Пометить как утвержденные</a>&nbsp;|&nbsp;</span>
                            ...
                            Пометить как неутвержденные</a><?php if ($review->status != 2): ?>&nbsp;|&nbsp;<?php endif; ?></span>
              ...
              <div class="tablenav">
                <div class="alignleft actions" style="float:left;">
                      ...
                      <input type="submit" class="button-secondary apply" name="act2" value="Применить" id="doaction2" />
                </div>
