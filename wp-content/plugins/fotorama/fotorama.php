...
function fotorama_gallery_shortcode($atts)
{
	...
	return "<div class='fotorama--wp' data-width='940' style='width: 940px;'  data-keyboard='true' data-hash='true' data-allowfullscreen='true' data-nav='thumbs' $data>$gallery</div>";
}
